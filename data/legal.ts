    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          `Grievance Officer: Shridhar Technologies, B-338, Emerald One, Jetalpur Road, Vadodara, Gujarat, India 390007. Email: ${siteConfig.email}. Phone: ${siteConfig.phone}.`,
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          `If you have questions about these Terms of Use, please contact us at ${siteConfig.email} or ${siteConfig.phone}.`,
        ],
      },
    ],
  },
